...
## HyP3 Architecture
HyP3 is a cloud processing pipeline with a serverless architecture. The design makes a clear distinction between HyP3 itself and the image processing plugins. See Figure FF for the AWS architecture diagram.
